...
<div class="container cols-offset-4-20 cols-offset-xl-2-21 pt5 specifications">
	<div class="col container cols-8-16 cols-sm-24 grid-gap">
		<?php if( have_rows('content') ):
	        ...
	        ?>
		<div class="col">
			<h2 class="heading heading__md mr1 ml2 m-sm-l0 m-sm-r0 heading__primary heading__caps font400 mt0"><?php the_sub_field('heading');?></h2>
		</div>
		...
		<?php if( have_rows('specifications') ):
            while ( have_rows('specifications') ) : the_row();
            	...
            	?>
        <div class="col">
			<h2 class="heading heading__md mr1 ml2 m-sm-l0 m-sm-r0 heading__primary heading__caps font400 mt0"><?php the_sub_field('title');?></h2>
		</div>
		<div class="col list list__style-line list__min-padding pb5">
			...
			<?php };?>
			<div class="p-sm-t1"><?php the_sub_field('table_note');?></div>
		</div>
		<?php  endwhile; endif;?>
		<div class="col"></div>
